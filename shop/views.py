...
def Show(request, category_slug = None):
    ...
    return render(request,'shop/products/show.html',{'category':category,'products':products,'cate':cate,'done':done})
...
def product_detail(request,id, slug):
    ...
    return render(request,'shop/products/detail.html',{'product':product,'form':form,'smiller':smiller,'cart':cart,'cate':cate,'done':done})
