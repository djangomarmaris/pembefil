...
class Slider(models.Model):
    ...
    discount = models.CharField(max_length=300, default='Discount')
    image = models.ImageField(upload_to='products/%y/%m/%d', blank=True,verbose_name='Resim : (868x655)')
...
class Blog(models.Model):
    image = models.ImageField(upload_to='products/%y/%m/%d', blank=True, verbose_name='Resim : (370x240)')
    list = models.ImageField(upload_to='products/%y/%m/%d', blank=True, verbose_name='Resim : (1170x714)')
...
class About(models.Model):
    title = models.CharField(max_length=1000, default='Title')
    info = RichTextUploadingField()
    title_two = models.CharField(max_length=1000, default='Title')
